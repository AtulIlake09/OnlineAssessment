                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col bg-light-danger px-6 py-8 rounded-2 mb-7">
                                                        ...
                                                        <div class="card"
                                                            ...
                                                            <div class="col-12 text-center mt-auto"><a href="#"
                                                                    class="text-danger fw-bold fs-3 mt-2">+</a></div>
                                                        </div>
                                                        <div class="col-12 text-center"><a href="#"
                                                                class="text-danger fw-bold fs-6 mt-2">New Category</a>
                                                        </div>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($category as $val)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label href="#"
                                                                            class="text-muted text-center fw-bolder d-block fs-6">{{ $val->id }}</label>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-trigger="hover"
                                                    title="Click to add a candidate">
                                                    <a href="#" class="btn btn-sm btn-light btn-active-primary"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_invite_friends">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                                        ...
                                                        <tbody>
                                                            @foreach ($candidate as $val)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label href="#"
                                                                            class="text-muted text-center fw-bolder d-block fs-6">{{ $val->category_id }}</label>
                                                                        {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
                                                                    </td>
                                                                    <td>
                                                                        <label href="#"
                                                                            class="text-muted text-center fw-bolder d-block fs-6">{{ $val->email }}</label>
                                                                        {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
                                                                    </td>
                                                                    <td>
                                                                        <label href="#"
                                                                            class="text-muted text-center fw-bolder d-block fs-6">{{ $val->mobile }}</label>
                                                                        {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
                                                                    </td>
                                                                    <td>
                                                                        <label href="#"
                                                                            class="text-muted text-center fw-bolder d-block fs-6">{{ $val->ip }}</label>
                                                                        {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
                                                                    </td>
                                                                    <td>
                                                                        <div
