												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-3 mb-7">
															...
															{{-- <span class="svg-icon svg-icon-3x text-center svg-icon-warning d-block my-2">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															...
															{{-- <div class="col-12 text-center"><a href="#" class="text-warning fw-bold fs-6">Categories
															...
															<!--end::Svg Icon-->
															<div class="col-12 text-center mt-5"><a href="#" class="text-warning fw-bold fs-3">{{empty($cat)?0:$cat}}</a></div>
															<div class="col-12 text-center"><a href="#" class="text-warning fw-bold fs-6">Categories</a></div>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-primary px-6 py-8 rounded-2 me-3 mb-7">
															<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
															{{-- <span class="svg-icon text-center svg-icon-3x svg-icon-primary d-block my-2">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															...
															<!--end::Svg Icon-->
															<div class="col-12 text-center mt-5"><a href="{{url('/assessment')}}" class="text-primary fw-bold fs-3">{{empty($can)?0:$can}}</a></div>
															<div class="col-12 text-center"><a href="{{url('/assessment')}}" class="text-primary fw-bold fs-6">Assessment</a></div>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-danger px-6 py-8 rounded-2 mb-7">
															...
															<!--end::Svg Icon-->
															<div class="card" style="width: 35px;height: 29px;margin: auto;margin-bottom: 8px;">
															<div class="col-12 text-center mt-auto"><a href="#" class="text-danger fw-bold fs-3 mt-2">+</a></div>
															</div>
															<div class="col-12 text-center"><a href="#" class="text-danger fw-bold fs-6 mt-2">New Category</a></div>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
														...
														<thead>
															<tr class="fw-bolder text-muted">
																...
																<th class="min-w-150px text-center">Category_id</th>
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<div class="d-flex align-items-center">
																		...
																		<div class="d-flex justify-content-start flex-column">
																			<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{$val->category}}</a>
																			{{-- <span class="text-muted fw-bold text-muted d-block fs-7">HTML, CSS, JS </span> --}}
																		</div>
																	</div>
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->id}}</label>
																...
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->time_period." min"}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<label href="#" class="text-dark fw-bolder d-block fs-6">{{$val->id}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-dark text-hover-primary fw-bolder d-block fs-6">{{$val->questions}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->category}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->type}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td class="text-center">
									...
									<div class="col-xl-12">
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 pt-5">
												...
												<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a candidate">
													<a href="#" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
													<span class="svg-icon svg-icon-3">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													...
													<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<label href="#" class="text-dark text-hover-primary fw-bolder d-block fs-6">{{$val->name}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->category_id}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->email}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->mobile}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<label href="#" class="text-muted text-center fw-bolder d-block fs-6">{{$val->ip}}</label>
																	{{-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> --}}
																</td>
																<td>
																	<div class="d-flex justify-content-end flex-shrink-0">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							<!--begin::Title-->
							<h1 class="mb-3">New Candidate</h1>
							<!--end::Title-->
							<hr>
							<form>
								<div class="form-row">
