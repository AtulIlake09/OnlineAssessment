                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end flex-shrink-0">
                                <a id="viewques" href="{{ url('/getques/' . $val->id) }}" type="button"
                                    class="btn btn-sm btn-icon btn-light btn-active-color-primary btn-sm me-1"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="view Questions">
                                ...
                                <a href="{{ url('/changecatStatus/' . $val->id) }}"
                                ...
                                <a class="delete btn btn-icon btn-bg-light btn-active-color-primary btn-sm"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Tests">
                                ...
                                <a href="#" class="category_modal btn btn-sm btn-light btn-active-primary"
                                    data-bs-toggle="modal" data-bs-target="#generatelinkmodal"
