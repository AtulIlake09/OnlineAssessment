...
<html lang="en">
   ...
   <body class="main-layout">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="{{url('/adminlogin')}}"><img src="{{asset('images/Logo-2.png')}}" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div style="margin-bottom: 0px;"
          class="alert alert-danger alert-dismissible fade show border border-danger" role="alert">
      ...
      <section class="banner_main">
         ...
         <div class="row d_flex justify-content-md-center">
            <div class="mx-auto">
               <form action="{{url('/adminlog')}}" method="POST" id="request" class="main_form" style="width: 33vmax;">
                <h2 style="color: aqua;font-weight: bold;text-align: center;">Admin Login</h2>
                  @csrf
                  <input type="hidden" name="category_id" value="">
                  <div class="row">
                     <div class="col-md-12 ">
                        <input class="contactus" placeholder="Email-ID" type="email" name="email" style="margin-top: 20px; margin-bottom: 0px;"> 
                     ...
                     <div class="col-md-12">
                        <input class="contactus" placeholder=" Password" type="password" name="password" style="margin-top: 20px; margin-bottom: 0px;"> 
                        <span style="color: rgb(230, 33, 33)"> 
                            @error('password')
                            {{$message}}
                            @enderror
