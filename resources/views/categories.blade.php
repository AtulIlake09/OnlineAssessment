                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <a href=""
                                                                            ...
                                                                            data-bs-target="#kt_modal_edit_category_{{ $val->id }}">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(".delete").on("click", function() {
                ...
                var id = col1.trim();
                var string_url = '/deletecategory/' + id;
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function(data) {
                                console.log(data);
                                if (data == 1) {
                                    swal("Yaa! Test successfully deleted!", {
                                        icon: "success",
                                    });
                                    currentRow.remove();
                                } else {
