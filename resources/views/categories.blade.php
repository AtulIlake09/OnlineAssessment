                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                                        ...
                                        <div class="row g-9 mb-8">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--begin::Select2-->
                                                <select name="category" id="inputCategory" class="form-control form-select form-select-solid" required>
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                                        ...
                                        <div class="row g-9 mb-8">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <!--begin::Select2-->
                                                <select name="category" id="inputnCategory" class="form-control form-select form-select-solid" required>
                                                    @php $i=1; @endphp
