                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <a href="{{route('question.create.step.one',['cat_id'=>$cat_id])}}" class="btn btn-sm btn-light btn-active-primary">
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                                ...
                                                <div class="col-md-12 fv-row">
                                                    ...
                                                    @if($val->type==2)
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="hidden" name="option_id1" value="{{isset($val->option1['option_id']) ? $val->option1['option_id'] : ''}}">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-text" style="border: 1px">
                                                            ...
                                                            <input type="hidden" name="option_id2" value="{{isset($val->option2['option_id']) ? $val->option2['option_id'] : '' }}">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-text" style="border: 1px">
                                                            ...
                                                            <input type="hidden" name="option_id3" value="{{isset($val->option3['option_id']) ? $val->option3['option_id'] : '' }}">
                                                        </div>
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-text" style="border: 1px">
                                                            ...
                                                            <input type="hidden" name="option_id4" value="{{isset($val->option4['option_id']) ? $val->option4['option_id'] : '' }}">
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="text-center">
