        ...
        @foreach ($data as $val)
            <tr>
                ...
                <td style="display:none;">
                    <label class="text-muted fw-bolder d-block fs-6">{{ $val->id }}</label>
                </td>
                <td>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="d-flex justify-content-start flex-column">
                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $val->name }}</a>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>
                    <label href="#" class="text-muted fw-bolder d-block fs-6">{{ $val->phone }}</label>
                </td>
                <td>
                ...
                <td>
                    <a href="" class="copylink" data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Copy Link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <td>
                    <label href="#" class="text-muted fw-bolder d-block fs-6">{{ $val->created_at }}</label>
                </td>
                ...
                <td>
                    <div class="d-flex justify-content-end flex-shrink-0">
                        ...
                        <a class="delete btn btn-icon btn-bg-light btn-active-color-primary btn-sm"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Delete Link">
